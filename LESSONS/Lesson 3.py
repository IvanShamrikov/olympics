...
#-------Рішення номер 2, простіше
n = 6
m = 3
k = 4
neighbors = 0

maxim = max(n, m, k) #обчислюємо вид яблук з максимальною к-стю
sum_else = n + m + k - maxim #обчислюємо к-сть яблук без першлї кучі

if maxim > sum_else: #якщо максимальна куча більша, то к-сть пар = сумі
    print(sum_else)
else:
    print(maxim)#якщо максимальна куча меньша, то к-сть пар = максимальній кучі
