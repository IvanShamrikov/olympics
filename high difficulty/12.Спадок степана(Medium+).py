...
# // У кожному із наступних N рядків записано по N цілих додатних чисел. j-е число i-го рядка означає, скільки буде платити
# i-ий житель за місце з номером j на цій стоянці.
...
# // INPUT
# // 2 1
# // 3 2 #Вартості паркомісць для 1го мешканця
# // 6 4 #Вартості паркомісць для 2го мешканця
#
# // OUTPUT
# // 8
#
# // #EXAMPLE 2
# // 4 1
# // 4 3 1 1 #Вартості паркомісць для 1го мешканця
# // 3 1 1 1 #Вартості паркомісць для 2го мешканця
# // 1 1 4 1 #Вартості паркомісць для 3го мешканця
# // 1 1 1 2 #Вартості паркомісць для 4го мешканця
#
# // OUTPUT
# // 12
